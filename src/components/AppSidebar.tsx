...
const menuItems: MenuItem[] = [
  ...
  { title: "Planos Tatuagem", url: "/admin/planos-tatuagem", icon: Package, roles: ["admin"] },
  { title: "Planos Odontologia", url: "/admin/planos-odontologia", icon: Package, roles: ["admin"] },
