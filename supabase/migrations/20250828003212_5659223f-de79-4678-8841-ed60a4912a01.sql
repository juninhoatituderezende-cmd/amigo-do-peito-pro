...
CREATE POLICY IF NOT EXISTS "Anyone can view plan images"
ON storage.objects FOR SELECT
USING (bucket_id = 'plan-images');

-- Política para upload de imagens de planos (admin)
CREATE POLICY IF NOT EXISTS "Admins can upload plan images"
...
CREATE POLICY IF NOT EXISTS "Admins can update plan images"
