...
-- 3. Corrigir RLS policies - remover acesso anônimo e exigir autenticação

-- Corrigir policy da tabela materials
...
-- Corrigir policy da tabela custom_plans  
...
-- Corrigir policy da tabela plan_groups
...
-- Corrigir policy da tabela services
